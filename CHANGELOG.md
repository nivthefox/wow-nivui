...
## [2.3.0](https://github.com/nivthefox/wow-nivui/releases/tag/v2.3.0) - 2026-08-26
...
- Overlay display types: Icon, Color, Frame (bar tint), and Border
- Overlay growth in all four directions, with a wrap setting for overflow

### Fixed

- Group member names stuck as "Player" now refresh automatically outside combat

### Removed

- The dispel indicator, replaced by the Frame and Border display types; existing settings are not migrated
...
- Right-click context menus now work correctly with ClickableRaidBuffs and similar addons installed
...
- Range fading now works correctly on target-of-target and similar dynamic units
- Party frames with custom visibility conditions now properly hide when in a raid
